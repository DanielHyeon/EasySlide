...
|---:|---|---:|---|
| 1 | `parameter` | 4778 | `LiveQueueItem? item` |
...
| ID | Kind | Line | Expression |
|---:|---|---:|---|
| 1 | `return` | 4781 | `return LegacyPointToPixel(format?.FontSize1) ?? ActiveLyricsFontSize;` |

## Assignments / Variable Declarations

| ID | Kind | Line | Expression |
|---:|---|---:|---|
| 1 | `variable_declaration` | 4780 | `var format = SongFormatData.Parse(item?.FormatData)` |

## Type Conversions / Object Creation

| ID | Kind | Line | Expression |
|---:|---|---:|---|
| 1 | `conversion_call` | 4780 | `SongFormatData.Parse(item?.FormatData)` |

## Invocations / Await / Object Creation

| ID | Kind | Line | Expression |
|---:|---|---:|---|
| 1 | `invocation_expression` | 4780 | `SongFormatData.Parse(item?.FormatData)` |
| 2 | `invocation_expression` | 4781 | `LegacyPointToPixel(format?.FontSize1)` |
