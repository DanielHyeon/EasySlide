...
|---:|---|---:|---|
| 1 | `parameter` | 4772 | `LiveQueueItem? item` |
...
| ID | Kind | Line | Expression |
|---:|---|---:|---|
| 1 | `return` | 4775 | `return CreateLyricsSampleBrush(format?.TextColorArgb1 ?? ActiveLyricsTextColorArgb);` |

## Assignments / Variable Declarations

| ID | Kind | Line | Expression |
|---:|---|---:|---|
| 1 | `variable_declaration` | 4774 | `var format = SongFormatData.Parse(item?.FormatData)` |

## Type Conversions / Object Creation

| ID | Kind | Line | Expression |
|---:|---|---:|---|
| 1 | `conversion_call` | 4774 | `SongFormatData.Parse(item?.FormatData)` |

## Invocations / Await / Object Creation

| ID | Kind | Line | Expression |
|---:|---|---:|---|
| 1 | `invocation_expression` | 4774 | `SongFormatData.Parse(item?.FormatData)` |
| 2 | `invocation_expression` | 4775 | `CreateLyricsSampleBrush(format?.TextColorArgb1 ?? ActiveLyricsTextColorArgb)` |
