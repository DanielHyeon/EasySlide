...
|---:|---|---:|---|
| 1 | `parameter` | 4798 | `LiveQueueItem? item` |

## Branch Conditions

| ID | Kind | Line | Expression |
|---:|---|---:|---|
| 1 | `switch_expression` | 4799 | `ResolveLyricsSampleTextAlignment(item) switch { LyricsTextAlignment.Left => System.Windows.TextAlignment.Left, LyricsTextAlignment.Right => System.Windows.TextAlignment.Right, _ => System.Windows.TextAlignment.Center, }` |
| 2 | `switch_arm` | 4801 | `LyricsTextAlignment.Left => System.Windows.TextAlignment.Left` |
| 3 | `switch_arm` | 4802 | `LyricsTextAlignment.Right => System.Windows.TextAlignment.Right` |
| 4 | `switch_arm` | 4803 | `_ => System.Windows.TextAlignment.Center` |

## Return Statements

| ID | Kind | Line | Expression |
|---:|---|---:|---|
| 1 | `return (expression-bodied)` | 4799 | `ResolveLyricsSampleTextAlignment(item) switch { LyricsTextAlignment.Left => System.Windows.TextAlignment.Left, LyricsTextAlignment.Right => System.Windows.TextAlignment.Right, _ => System.Windows.TextAlignment.Center, }` |
...
| ID | Kind | Line | Expression |
|---:|---|---:|---|
| 1 | `invocation_expression` | 4799 | `ResolveLyricsSampleTextAlignment(item)` |
