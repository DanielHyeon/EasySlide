...
public static class LegacySettingsMap
{
    ...
    [
        ...
        Automated("LyricsMonitorTransitionKind", EasiSettingKeys.LyricsMonitorTransitionKind.Id, SettingsSectionKind.LiveOutput, LegacySettingValueKind.Enum, "WPF compatibility", "Output transition motion (Fade/Slide 4-way) — FrmMain transition effect (implemented subset)."),
