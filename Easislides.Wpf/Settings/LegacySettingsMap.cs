...
public static class LegacySettingsMap
{
    ...
    [
        ...
        Automated("LyricsMonitorPanelShadow", EasiSettingKeys.LyricsMonitorPanelShadow.Id, SettingsSectionKind.LiveOutput, LegacySettingValueKind.Boolean, "WPF compatibility", "Display Panel shadow text effect - FrmMain Def_PanelFont Shadow."),
        Automated("LyricsMonitorPanelOutline", EasiSettingKeys.LyricsMonitorPanelOutline.Id, SettingsSectionKind.LiveOutput, LegacySettingValueKind.Boolean, "WPF compatibility", "Display Panel outline text effect - FrmMain Def_PanelFont Outline."),
        ...
        Automated("CurrentWorshipListName", EasiSettingKeys.CurrentWorshipListName.Id, SettingsSectionKind.Data, LegacySettingValueKind.String, "WPF compatibility", "Current WPF SessionList selection alias."),
        Automated("current_session", EasiSettingKeys.CurrentWorshipListName.Id, SettingsSectionKind.Data, LegacySettingValueKind.String, "RegUtil config/current_session", "Legacy current Worship List session restored on startup."),
        Automated("CurSession", EasiSettingKeys.CurrentWorshipListName.Id, SettingsSectionKind.Data, LegacySettingValueKind.String, "Gf.CurSession", "Legacy current Worship List runtime name."),
