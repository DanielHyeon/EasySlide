...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/.gsd-surface.json`
(sibling to `E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/skills`).
...
`E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/.gsd-surface.json`).
...
<execution_context>
Surface state file: `E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/.gsd-surface.json`
Install profile marker: `E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/.gsd-profile`
Skill dirs: `E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/skills/gsd-*/`
Engine module: `E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
