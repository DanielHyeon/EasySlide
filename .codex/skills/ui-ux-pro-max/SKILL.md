...
> Codex path note: bundled scripts are resolved relative to this skill directory. Run the examples from `C:\Users\Admin\.codex\skills\ui-ux-pro-max`, or invoke `scripts/search.py` by resolving it relative to this `SKILL.md` file.
