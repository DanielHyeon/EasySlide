...
<template>
@E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/workflows/transition.md`.
...
- Follow @E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/workflows/diagnose-issues.md
