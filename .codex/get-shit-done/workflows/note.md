...
- **Global scope**: `E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/notes/`)
...
2. Glob `E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/notes/*.md` (if directory exists) — global notes
...
Global (E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/notes/` — works in any directory
