...
<required_reading>
@E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/references/ai-frameworks.md
@E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/agents/gsd-eval-planner.md for instructions.
