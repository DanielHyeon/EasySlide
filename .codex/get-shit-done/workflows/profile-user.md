...
Key references:
- @E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/references/ui-brand.md (display patterns)
- @E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/agents/gsd-user-profiler.md (profiler agent definition)
- @E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/USER-PROFILE.md"
...
```bash
cp "E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/USER-PROFILE.md" "E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/USER-PROFILE.backup.md"
```
...
✓ Stores profile at E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/USER-PROFILE.md
...
Run session scan:
```bash
_GSD_SHIM_NAME="gsd-tools.cjs"; _GSD_RUNTIME_ROOT="${RUNTIME_DIR:-$(git rev-parse --show-toplevel 2>/dev/null || pwd)}"; GSD_TOOLS="${_GSD_RUNTIME_ROOT}/get-shit-done/bin/${_GSD_SHIM_NAME}"; if [ -f "$GSD_TOOLS" ]; then gsd_run() { node "$GSD_TOOLS" "$@"; }; elif [ -f "${_GSD_RUNTIME_ROOT}/.claude/get-shit-done/bin/${_GSD_SHIM_NAME}" ]; then GSD_TOOLS="${_GSD_RUNTIME_ROOT}/.claude/get-shit-done/bin/${_GSD_SHIM_NAME}"; gsd_run() { node "$GSD_TOOLS" "$@"; }; elif command -v gsd-tools >/dev/null 2>&1; then GSD_TOOLS="$(command -v gsd-tools)"; gsd_run() { "$GSD_TOOLS" "$@"; }; elif [ -f "E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/bin/${_GSD_SHIM_NAME}" ]; then GSD_TOOLS="E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/bin/${_GSD_SHIM_NAME}"; gsd_run() { node "$GSD_TOOLS" "$@"; }; else echo "ERROR: gsd-tools.cjs not found at $GSD_TOOLS and gsd-tools is not on PATH. Run: npx -y @opengsd/gsd-core@latest --claude --local" >&2; exit 1; fi
...
- The user-profiling reference doc at `E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/references/user-profiling.md`
...
Reference: @E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated $gsd-dev-preferences at E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/AGENTS.md"
...
```bash
BACKUP_PATH="E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/USER-PROFILE.backup.md"
```
...
Your profile:    E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ $gsd-dev-preferences   E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/AGENTS.md
```
