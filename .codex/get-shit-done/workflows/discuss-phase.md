...
<required_reading>
@E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/references/domain-probes.md
@E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/references/gate-prompts.md
@E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
if [ -f "E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/USER-PROFILE.md" ]; then
  ADVISOR_MODE=true
else
  ADVISOR_MODE=false
fi
...
Read `@E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/references/scout-codebase.md` — it contains the phase-type→map selection table, single-read rule, no-maps fallback, and `<codebase_context>` output schema. Then execute:
