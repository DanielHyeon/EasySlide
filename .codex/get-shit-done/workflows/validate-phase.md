...
```
Agent(
  prompt="Read E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/templates/VALIDATION.md`
