...
```markdown
Read E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/agents/gsd-ui-researcher.md for instructions.
...
Template: E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/agents/gsd-ui-checker.md for instructions.
