...
INSTALL_JS_GLOBAL="E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
