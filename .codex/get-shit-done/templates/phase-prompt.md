...
<!-- For checkpoint task examples and patterns, see @E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/references/checkpoints.md -->
...
See `E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/workflows/verify-phase.md` for verification logic.
