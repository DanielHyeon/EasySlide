...
- Usage: Reference from command with `@E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to E:/WorkSpace/wp-ms/dev/EasiSlides_v2.6.4/.codex/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
