...
public class MainMenuBarTests
{
    ...
    public void LeftBrowserTabs_ExposeInlinePowerPointAndMediaSources()
    {
        ...
        xaml.Should().Contain("x:Name=\"Def_HeadAlign\"", "Default tab should expose FrmMain Def_HeadAlign");
        xaml.Should().Contain("x:Name=\"Def_HeadAlignAsR1\"", "Def_HeadAlign should expose FrmMain As Region 1 option");
        xaml.Should().Contain("x:Name=\"Def_HeadAlignAsR2\"", "Def_HeadAlign should expose FrmMain As Region 2 option");
        xaml.Should().Contain("x:Name=\"Def_HeadAlignLeft\"", "Def_HeadAlign should expose FrmMain left option");
        xaml.Should().Contain("x:Name=\"Def_HeadAlignCentre\"", "Def_HeadAlign should expose FrmMain centre option");
        xaml.Should().Contain("x:Name=\"Def_HeadAlignRight\"", "Def_HeadAlign should expose FrmMain right option");
        xaml.Should().Contain("ApplyTitleHeadingLegacyModeCommand", "Def_HeadAlign should use the exclusive FrmMain dropdown-mode command");
        ...
        xaml.Should().Contain("x:Name=\"Def_R2Colour\"", "Default tab should expose FrmMain Def_R2Colour");
        xaml.Should().Contain("ItemsSource=\"{Binding LyricsTextColor2Presets}\"", "Def_R2Colour should use the real Region2 colour presets");
        xaml.Should().Contain("SelectedValue=\"{Binding LyricsTextColor2Input, Mode=TwoWay}\"", "Def_R2Colour should persist the Region2 default colour");
        xaml.Should().Contain("ItemTemplate=\"{StaticResource ColorPresetItemTemplate}\"", "Def_R2Colour should show colour swatches instead of code-only text");
        ...
        xaml.Should().Contain("x:Name=\"Def_BackColourSwatch\"", "Def_BackColour should show the current default background as a colour swatch");
        xaml.Should().NotContain("x:Name=\"Def_BackColourHex\"", "Def_BackColour should not expose the raw colour code as the primary UI");
        xaml.Should().Contain("ActiveBackgroundColorHex", "Def_BackColour should reflect the current default background colour");
        xaml.Should().Contain("Background=\"{Binding ActiveBackgroundColorHex, Converter={StaticResource ColorValueToBrush}}\"", "Def_BackColour should render the current background colour visually");
        ...
        xaml.Should().Contain("x:Name=\"Def_PanelShow\"", "Default tab should expose FrmMain Def_PanelShow");
        xaml.Should().Contain("ToggleLyricsDisplayPanelCommand", "Def_PanelShow should toggle the whole display panel overlay");
        xaml.Should().Contain("x:Name=\"Def_PanelTitle\"", "Default tab should expose FrmMain Def_PanelTitle");
        xaml.Should().Contain("ToggleLyricsTitleOnPanelCommand", "Def_PanelTitle should use the same live display-panel toggle as Output menu");
        xaml.Should().Contain("x:Name=\"Def_PanelSong\"", "Default tab should expose FrmMain Def_PanelSong");
        xaml.Should().Contain("ToggleLyricsItemNumberCommand", "Def_PanelSong should toggle song/item number visibility");
        xaml.Should().Contain("x:Name=\"Def_PanelSlides\"", "Default tab should expose FrmMain Def_PanelSlides");
        xaml.Should().Contain("ToggleLyricsPositionIndicatorCommand", "Def_PanelSlides should toggle the slide/page position indicator");
        xaml.Should().Contain("x:Name=\"Def_PanelCopyright\"", "Default tab should expose FrmMain Def_PanelCopyright");
        xaml.Should().Contain("ToggleLyricsCopyrightCommand", "Def_PanelCopyright should toggle copyright text in the display panel");
        xaml.Should().Contain("x:Name=\"Def_PanelPrevNext\"", "Default tab should expose FrmMain Def_PanelPrevNext");
        ...
        xaml.Should().Contain("x:Name=\"Def_PanelBackColourSwatch\"", "Def_PanelBackColour should show the current panel background as a colour swatch");
        xaml.Should().NotContain("x:Name=\"Def_PanelBackColourHex\"", "Def_PanelBackColour should not expose the raw colour code as the primary UI");
        xaml.Should().Contain("ActivePanelColorHex", "Def_PanelBackColour should reflect the current display-panel band color");
        xaml.Should().Contain("Background=\"{Binding ActivePanelColorHex, Converter={StaticResource ColorValueToBrush}}\"", "Def_PanelBackColour should render the panel background colour visually");
        ...
        xaml.Should().Contain("x:Name=\"Def_PanelTextColourSwatch\"", "Def_PanelTextColour should show the current panel text colour as a swatch");
        xaml.Should().NotContain("x:Name=\"Def_PanelTextColourHex\"", "Def_PanelTextColour should not expose the raw colour code as the primary UI");
        xaml.Should().Contain("ActivePanelTextColorHex", "Def_PanelTextColour should reflect the current display-panel text color");
        xaml.Should().Contain("Background=\"{Binding ActivePanelTextColorHex, Converter={StaticResource ColorValueToBrush}}\"", "Def_PanelTextColour should render the panel text colour visually");
        ...
        xaml.Should().Contain("x:Name=\"TextColorSwatch\"", "Default detail settings should show the current text colour as a swatch");
        xaml.Should().Contain("x:Name=\"BackgroundColorSwatch\"", "Default detail settings should show the current background colour as a swatch");
        xaml.Should().NotContain("x:Name=\"TextColorHexBox\"", "Default detail settings should not show the raw text colour code as the primary UI");
        xaml.Should().NotContain("x:Name=\"BackgroundColorHexBox\"", "Default detail settings should not show the raw background colour code as the primary UI");
