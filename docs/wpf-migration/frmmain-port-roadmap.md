...
- ✅ **이중 언어(Region 1/2) 트랙 사실상 완성**: 파서·송출·영역별 색·Sequence·영역별 정렬. 잔여 minor: 영역별 폰트 독립, 이중언어 절점프 라벨.
- **차기: 증분 5~10 — Display Panel(송출 정보 바)·조옮김/코드·전환 효과 UI·이미지/PraiseBook 브라우징.**
