...
| 테스트 인프라 | `Easislides.Wpf.Tests`, xUnit/FluentAssertions, 51개 테스트 | 완료 |
| 실제 기능 이식 | WinForms 화면과 전역 함수가 여전히 운영 기능의 원본 | 미완료 |
...
결과: 빌드 성공, 테스트 51개 통과. 단, 기존 NetOffice/DirectShow/HookManager 경고는 남아 있다.
