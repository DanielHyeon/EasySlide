...
| 테스트 인프라 | `Easislides.Wpf.Tests`, xUnit/FluentAssertions, 393개 테스트 | 완료 |
| 거버넌스 자동화 | `Easislides.Analyzers` EasiDS001(매직 색·폰트 차단) + 12개 분석기 테스트, WPF에 Analyzer 참조 | 1차 완료(EasiDS002 StyleCop a11y 예정) |
...
결과: 빌드 성공, 테스트 375개 통과. 단, 기존 NetOffice/DirectShow/HookManager 경고는 남아 있다.
