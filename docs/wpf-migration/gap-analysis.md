...
- [ ] **다음 결정 대상**: PPT 썸네일 스트립(G1.2 잔여) 또는 G1.4 출력 렌더 패리티(스크린샷 기준 확대) 중 착수 선택
