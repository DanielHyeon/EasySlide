...
| `Ind_R1Bold/Italics(3종)/Underline`, R2 동일 | 영역별 굵게/기울임(없음/전체/후렴만)/밑줄 | 🟢 (증분 46/47) 영역별 굵게/기울임 + (증분 48) 밑줄 전역 토글 + (증분 49) **영역별 밑줄**(FormatData 41 bit2/bit5, Region1=곡별∥전역, Region2=곡별∥Region1 추종). ChorusOnly(후렴만)·외곽선 모드 밑줄은 후속. 레거시 비트 한계로 굵게/기울임/밑줄 "끄기"는 전역 추종 |
