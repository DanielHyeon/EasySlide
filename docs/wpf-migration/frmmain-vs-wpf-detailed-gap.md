...
| FrmMain | WPF | 상태 |
|---|---|---|
| 폴더+곡 목록, 정렬(획수/CJK단어수/곡번호), A/B/C 점프, Use Song Numbering | 라이브러리 탭(폴더+검색+초성 점프 바) | 🟡 (2026-06-01 증분 34) **A/B/C(초성) 점프 추가**(`SongInitialGrouping`+점프 바). 정렬(획수/번호)·Use Song Numbering 은 후속 |
