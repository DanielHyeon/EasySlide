...
- `AppServiceRegistrationTests.ConfigureServices_ResolvesPowerPointRenderServiceWithSettingsBackedConstructor`: 운영 DI 등록이 PowerPoint 설정 소비 생성자와 Library ViewModel/Window 등록을 사용하도록 고정
...
- `dotnet test Easislides.Wpf.Tests\Easislides.Wpf.Tests.csproj -c Debug`: 270개 통과
