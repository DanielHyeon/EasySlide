...
namespace Easislides.Util
{
    class DataUtil
    {
		...
		public static int GetDataInt(DataRow rs, string Fieldname, bool Minus1IfBlank)
		{
			try
			{
				return DataUtil.ObjToInt(rs[Fieldname], Minus1IfBlank);
			}
			catch
			{
		...
		public static double GetDataDouble(DataRow rs, string Fieldname)
		{
			try
			{
				return DataUtil.ObjToDouble(rs[Fieldname]);
			}
			catch
			{
				return 0.0;
