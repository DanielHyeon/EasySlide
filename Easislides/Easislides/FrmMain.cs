...
namespace Easislides
{
    public partial class FrmMain : Form
    {
        ...
        // PowerPoint 썸네일 클릭 처리를 위한 타이머 및 플래그
        ...
        private void PowerPointImage_MouseUp(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                ...
                // 단일 클릭 처리를 지연시키는 타이머 생성 (더블클릭 감지 시간: 300ms)
        ...
        /// <summary>
        /// PowerPoint 썸네일 더블클릭 이벤트 핸들러
        /// 더블클릭 시 PowerPoint 슬라이드쇼 창을 활성화하고 애니메이션/동영상을 재생합니다.
        /// </summary>
        private void PowerPointImage_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                // 더블클릭 플래그 설정 (단일 클릭 타이머 무효화)
