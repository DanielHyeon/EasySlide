...
namespace Easislides
{
    internal unsafe class ImageTransitionControl : Control
	{
			...
			if (_currentPercentage < 100f)
			{
				...
				else if (TransitionType == TransitionTypes.Ascend)
				{
					...
					if (TransitBackPictureAction == BackPicturesTransition.None)
					{
						...
						num3 = (colorMatrix.Matrix33 = ((num3 > 1f) ? 1f : ((num3 < 0f) ? 0f : num3)));
						imageAttributes.SetColorMatrix(colorMatrix);
						DrawImageToOutput(e, _currentTextImage, base.ClientRectangle, new Rectangle(0, 0, _newCombinedImage.Width, _newCombinedImage.Height), DrawAlert: true, imageAttributes, PanelType.Current);
						...
						DrawImageToOutput(e, _newTextImage, base.ClientRectangle, new Rectangle(0, num2, _newCombinedImage.Width, _newCombinedImage.Height), DrawAlert: true, imageAttributes, PanelType.New);
					}
					else
					{
						Draw_CurrentImage(e);
						colorMatrix.Matrix33 = 0.003921569f * (255f * _currentPercentage / 100f);
						imageAttributes.SetColorMatrix(colorMatrix);
						num = 0.15f * (float)_newCombinedImage.Height;
						num2 = (int)(num * _currentPercentage / 100f - num);
						DrawImageToOutput(e, _newCombinedImage, base.ClientRectangle, new Rectangle(0, num2, _newCombinedImage.Width, _newCombinedImage.Height), DrawAlert: true, imageAttributes);
					}
				...
				else if (TransitionType == TransitionTypes.Fade)
				{
					...
					colorMatrix.Matrix33 = 0.003921569f * (255f * _currentPercentage / 100f);
					imageAttributes.SetColorMatrix(colorMatrix);
					DrawImageToOutput(e, _newCombinedImage, base.ClientRectangle, new Rectangle(0, 0, _newCombinedImage.Width, _newCombinedImage.Height), DrawAlert: true, imageAttributes);
					//imageAttributes.Dispose();
				}
				...
				else if (TransitionType == TransitionTypes.Gentle_Zoom)
				{
					...
					else
					{
						...
						num3 = (colorMatrix.Matrix33 = ((num3 > 1f) ? 1f : ((num3 < 0f) ? 0f : num3)));
						imageAttributes.SetColorMatrix(colorMatrix);
						DrawImageToOutput(e, _currentCombinedImage, base.ClientRectangle, new Rectangle(0, 0, _currentBackgroundPicture.Width, _currentBackgroundPicture.Height), DrawAlert: false, imageAttributes);
						num3 = 0.003921569f * (510f * _currentPercentage / 100f);
						num3 = (colorMatrix.Matrix33 = ((num3 > 1f) ? 1f : ((num3 < 0f) ? 0f : num3)));
						imageAttributes.SetColorMatrix(colorMatrix);
						...
						DrawImageToOutput(e, _newCombinedImage, new Rectangle(-base.Width / 2, -1 - base.Height / 2, base.Width, base.Height), new Rectangle(0, 0, _newCombinedImage.Width, _newCombinedImage.Height), DrawAlert: true, imageAttributes);
						matrix2.Dispose();
						//imageAttributes.Dispose();
					}
				}
				...
				else if (TransitionType == TransitionTypes.Spin)
				{
					...
					if (TransitBackPictureAction == BackPicturesTransition.None)
					{
						...
						ImageAttributes imageAttributes = new ImageAttributes();
						ColorMatrix colorMatrix = new ColorMatrix();
						colorMatrix.Matrix33 = 0.003921569f * (255f * (1f - _currentPercentage / 100f));
						imageAttributes.SetColorMatrix(colorMatrix);
						DrawImageToOutput(e, _currentTextImage, base.ClientRectangle, new Rectangle(0, 0, _newCombinedImage.Width, _newCombinedImage.Height), DrawAlert: false, imageAttributes, PanelType.Current);
				...
				else if (TransitionType == TransitionTypes.Spiral)
				{
					...
					if (TransitBackPictureAction == BackPicturesTransition.None)
					{
						ImageAttributes imageAttributes = new ImageAttributes();
						ColorMatrix colorMatrix = new ColorMatrix();
						colorMatrix.Matrix33 = 0.003921569f * (255f * (1f - _currentPercentage / 200f));
						imageAttributes.SetColorMatrix(colorMatrix);
						...
						DrawImageToOutput(e, _currentTextImage, base.ClientRectangle, new Rectangle(0, 0, _currentTextImage.Width, _currentTextImage.Height), DrawAlert: false, imageAttributes, PanelType.Current);
				...
				else if (TransitionType == TransitionTypes.Away)
				{
					if (TransitBackPictureAction == BackPicturesTransition.None)
					{
						...
						e.Graphics.Transform = matrix;
						DrawImageToOutput(e, _currentTextImage, new Rectangle(-base.Width / 2, 0, base.Width, base.Height), new Rectangle(0, 0, _newCombinedImage.Width, _newCombinedImage.Height), DrawAlert: false, imageAttributes, PanelType.CurrentWithTrans);
						imageAttributes.Dispose();
						matrix.Dispose();
					}
					else
				...
				else if (TransitionType == TransitionTypes.Zoom_Away)
				{
					if (TransitBackPictureAction == BackPicturesTransition.None)
					{
						...
						Matrix matrix = new Matrix(num16, 0f, 0f, num16, dx, (float)base.Height * (1f - num16));
						e.Graphics.Transform = matrix;
						DrawImageToOutput(e, _currentTextImage, new Rectangle(-base.Width / 2, 0, base.Width, base.Height), new Rectangle(0, 0, _newCombinedImage.Width, _newCombinedImage.Height), DrawAlert: false, imageAttributes, PanelType.Current);
						imageAttributes.Dispose();
						dx = base.Width / 2;
						dy = base.Height / 3;
				...
				else if (TransitionType == TransitionTypes.RandomBars)
				{
					...
					{
						num37 = random.Next(num38);
						while (BitsArray[num37])
						{
							num37++;
				...
				else if (TransitionType == TransitionTypes.Dissolve)
				{
					...
					{
						num40 = random.Next(DissolveTotal);
						BitsArray[num40] = true;
					}
					TotalBitsArraySet = 0;
					int num42 = 0;
					int num43 = 0;
		...
		private void DrawImageToOutputBitBlt(PaintEventArgs e, Image InImage, Rectangle DestinationRectangle, Rectangle SourceRectangle, bool DrawAlert, ImageAttributes InImageAttributes, PanelType InPanelType)
		{
			...
			Debouncer.Debounce("GC.Collect,2", () =>
            {
